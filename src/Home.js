    ...
    <div className="App">
        ...
        <div className="home-contents"> 
            ...
            <div className="main-page-p-box">
                ...
                <p className="main-page-sub-p"> I'm a strategy professional based in Chicago, currently at Motorola Solutions. I focus on research & quantitative analysis for strategic projects and tech M&A. </p>
