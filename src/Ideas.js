...
function Ideas() {
  ...
  const quote={
                body:[
                  ...
                  {quote: 
                    "The cultural, or institutional rule is: no polymaths allowed. You can be narrowly specialized, and if you are interested in other things, you better keep it to youself and not tell people... because if say you are interested in computer science and also music or studying the Hebrew bible, well, that must mean you are just not very serious about computer science", 
                  author: 
